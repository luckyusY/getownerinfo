...
export default function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-line bg-surface/92 backdrop-blur-md">
      <div className="hidden border-b border-line/70 bg-ink text-white/78 sm:block">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-1.5 text-xs font-semibold">
